...
target_iterator = [a for a in center_diff_array] # this will eventually be the combination of two different functions
...
def evaluate_model(data, ms_iter = multi_starts_AIC):
...
f = open(f'{data_folder}/hprParameter_AIC_sp_{rad_diff}_rng_{center_range}_{day}{month}{year}.pkl','wb')
